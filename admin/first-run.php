...
<ul li="block-list">
	<li><a href="feed-import.php?service=greader"><?php _e('Google Reader') ?></a></li>
	<li><a href="feed-import.php?service=bloglines"><?php _e('Bloglines') ?></a></li>
	<li><a href="feed-import.php?service=other"><?php _e('Others') ?></a></li>
</ul>
...
<a href="javascript:void(sp=window.open(<?phpecho get_option('baseurl')?>/admin/subscribe.php?url='+escape(document.location),'lilina','toolbar=no,width=800,height=600,scrollbars=yes'));%20void(setTimeout(function(){sp.focus()},100));"><?php _e('Subscribe') ?></a></p>
<?php
admin_footer();